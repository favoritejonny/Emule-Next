...
public:
	...
	BOOL EnableSubMenu(HMENU hSubMenu, UINT nEnable);
	BOOL RemoveSubMenu(HMENU hSubMenu);
...
protected:
	...
	CMap<CString, LPCTSTR, int, int> m_mapIconNameToIconIdx;
	CMap<CString, LPCTSTR, HBITMAP, HBITMAP> m_mapIconNameToBitmap;
	...
	int FindSubMenuPosition(HMENU hSubMenu) const;
