...
public:
	...
	CString	GetEd2kConnectionStateString() const;
	CString	GetKadConnectionStateString() const;
	UINT GetConnectionStateIconIndex() const;
	UINT GetEd2kConnectionStateIconIndex() const;
	UINT GetKadConnectionStateIconIndex() const;
