...
#define	DEFAULT_NICK			EMULE_NEXT_DEFAULT_ALIAS
...
public:
	...
	static LPCTSTR GetProductName()					{ return EMULE_NEXT_PRODUCT_NAME; }
	static LPCTSTR GetProductVersion()					{ return EMULE_NEXT_VERSION_STRING; }
	static LPCTSTR GetProductDisplayName()				{ return EMULE_NEXT_PRODUCT_DISPLAY_NAME; }
...
protected:
	...
	CMap<CString, LPCTSTR, int, int> m_aExtToSysImgIdx;
	CSize		m_sizSmallSystemIcon;

	HIMAGELIST	m_hBigSystemImageList;
	CMap<CString, LPCTSTR, int, int> m_aBigExtToSysImgIdx;
