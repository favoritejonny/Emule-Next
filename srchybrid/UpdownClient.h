...
//	void PrintUploadStatus();
	...
	bool			SendBuddyPingPong()	const						{ return IsTickCountDue(::GetTickCount(), m_dwLastBuddyPingPongTime); }
	bool			AllowIncomingBuddyPingPong() const				{ return HasTickCountElapsed(::GetTickCount(), m_dwLastBuddyPingPongTime, MIN2MS(3)); }
...
protected:
	...
	bool	RecentlySwappedForSourceExchange() const	{ return lastSwapForSourceExchangeTick != 0 && !HasTickCountElapsed(::GetTickCount(), lastSwapForSourceExchangeTick, SEC2MS(30)); } // ZZ:DownloadManager
