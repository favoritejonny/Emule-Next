...
BEGIN_MESSAGE_MAP(CTransferWnd, CResizableFormView)
	...
	ON_BN_CLICKED(IDC_BUGREPORT, OnBnClickedBugReport)
	ON_WM_CTLCOLOR()
	ON_WM_HELPINFO()
	ON_WM_LBUTTONUP()
	ON_WM_MOUSEMOVE()
...
void CTransferWnd::OnInitialUpdate()
{
	...
	AddAnchor(IDC_BUGREPORT, TOP_RIGHT);
...
void CTransferWnd::Localize()
{
	...
	SetDlgItemText(IDC_BUGREPORT, GetResString(IDS_REPORT_BUG));
