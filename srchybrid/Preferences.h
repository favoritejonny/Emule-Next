...
public:
	...
	// A portable package places the marker file beside eMuleNext.exe. In this mode
	// all mutable data stays in the application directory and registry integration
	// is disabled.
...
#define GetBindAddr  GetBindAddrA
	...
	static void		SetAutoStart( bool val)				{ m_bAutoStart = IsPortableMode() ? false : val; }
	...
	static UINT		GetDefaultMaxHalfConnections();
	...
	static bool		GetSparsePartFiles(LPCTSTR pszPath = NULL);
